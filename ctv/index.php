...
<body>
	...
	<main class="container">
		<div class="row">
			<div class="col-md-10">
				<h2 style="color: blue; font-weight: bold"><i class="fa fa-circle-o-notch fa-spin fa-fw"></i>Trang Chức Năng Của Công Tác Viên<i class="fa fa-circle-o-notch fa-spin fa-fw "></i></h2><br><br>
