...
<body>
	...
	<section class="container">
		<div class="row">
			<div class="col-md-4">
				<img src="img/sp2.png" alt="Ảnh Sản Phẩm 2" class="img-thumbnail">
			</div>
			<div class="col-md-4">
				<h2>Gạo Tiêu Chuẩn</h2><br>
				<input type="hidden" value="Gạo Tiêu Chuẩn" id="tenGao">
				<h4>Đánh Giá: <span style="color: #187ffe;"><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i><i class="glyphicon glyphicon-star"></i></span></h4>
				<h4>Giá: 20.000đ/kg </h4>
				<input type="hidden" value="20.000" id="donGia">
				...
				<h3>Loại Bao</h3>
				<div class="radio">
					<label><input type="radio" name="optradio" checked="actived">Bao Thường</label>
				</div>
				<div class="radio">
					<label><input type="radio" name="optradio">Bao Đẹp</label>
				</div>
				...
				<button type="button" class="btn btn-success" onclick="muaHang();"><i class="glyphicon glyphicon-shopping-cart"></i>   Mua Hàng</button></a><br><br><br>
			</div>
...
<script>
	...
	function tt() {
		...
		document.getElementById('ThanhTien').value = SL*20000;
	}
</script>
