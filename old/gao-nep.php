...
<body>
	...
	<section class="container">
		<div class="row">
			<div class="col-md-4">
				<img src="img/sp3.png" alt="Ảnh Sản Phẩm 3" class="img-thumbnail">
			</div>
			<div class="col-md-4">
				<h2>Gạo Nếp</h2><br>
				<input type="hidden" value="Gạo Nếp" id="tenGao">
				...
				<h4>Giá: 15.000đ/kg </h4>
				<input type="hidden" value="15.000" id="donGia">
...
<script>
	...
	function tt() {
		...
		document.getElementById('ThanhTien').value = SL*15000;
	}
</script>
